...
\chapter{Deterministic models for bat movement}
%\include{tex/radiotrack}
\include{tex/methodsphase1}
%\include{tex/methodsphase2}
...
Finite number of bats in a roost, stochastic model better to describe noise

	\section{A stochastic diffusion model}

	\section{Leapfrog model: return to roost}

\chapter{Methods for locating bat roosts}
...
%	\include{roostfinding}

\chapter{Landscape}

	\section{Circuitscape}
